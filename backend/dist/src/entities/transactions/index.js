...
__decorate([
    (0, typeorm_1.ManyToOne)(() => accounts_1.Account, account => account.creditedTransaction),
    __metadata("design:type", String)
], Transaction.prototype, "creditedAccountId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => accounts_1.Account, account => account.debitedTransaction),
    __metadata("design:type", String)
