...
describe('Tests for user service', () => {
    ...
    it('Must be able to view a profile', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, createUser_service_1.createUserService)(mocks_1.user);
        const result = yield (0, viewProfile_service_1.viewProfileService)(mocks_1.user.username);
