...
describe('Tests for transaction service', () => {
    ...
    it('Must be able to list transactions', () => __awaiter(void 0, void 0, void 0, function* () {
        const newUser = yield (0, createUser_service_1.createUserService)(mocks_1.user);
        const result = yield (0, listTransactions_service_1.listTransactionsService)(newUser.accountId);
