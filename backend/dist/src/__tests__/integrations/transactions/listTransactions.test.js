...
describe('Tests for transaction routes', () => {
    ...
    test('Must be able to list transactions', () => __awaiter(void 0, void 0, void 0, function* () {
        const login = yield (0, supertest_1.default)(app_1.app).post('/session').send(mocks_1.session);
        const token = login.body.token;
        const response = yield (0, supertest_1.default)(app_1.app).get('/transactions').set('Authorization', `Bearer ${token}`);
        expect(response.status).toBe(200);
        expect(response.body).toHaveProperty('map');
    }));
    test('Must be able to prevent listing transactions without token', () => __awaiter(void 0, void 0, void 0, function* () {
